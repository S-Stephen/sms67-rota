...
(function(){  
  ...
  var app = angular.module('SchedulesModule',['ui.bootstrap','myReuseableMod']);
  ...
  app.controller('MyScheduleController',['$http','$scope','$rootScope','handleMySocketsSrvc', function($http,$scope,$rootScope,handleMySocketsSrvc){
	...
	//include our service to handle the sockets!
